                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="payment-details pl-10 mb-50" style="padding-left: 0px">
                          ...
                          <table>
                            <tr>
                              <td  style="font-size: 20px" class="order-total-price">{{number_format($gia)}} đ</td>
                            </tr>
                          </table>
                        </div>
                        <!-- payment-method -->
                            ...
                            <div class="product-tab">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" id="popular-product">
                                  <form action="{{route('dathangngay')}}" method="post">
                                    @csrf
                                    <input type="hidden" id="tien" name="total" value="{{$gia}}">
                                    ...
                                    <input type="hidden" value="{{$soluong}}" name="soluongdathang">
                                    <div class="payment-details pl-10 mb-50" style="padding-left: 0px">
                                      <h6 class="widget-title border-left mb-20">Tổng Tiền</h6>
                                      <span style="font-size: 20px;font-family: roboto;color: black;font-weight: 700" id="tongtien">{{number_format($gia)}}</span><span style="font-size: 20px;font-family: roboto;color:black;font-weight: 700"> đ</span>
                                    </div>
