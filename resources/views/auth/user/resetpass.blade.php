...
<head>
    ...
    <link rel="stylesheet" href="thethao/css/style-customizer.css">
...
<div class="wrapper">
    ...
    <div class="login-section mb-80">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="registered-customers">
                        ...
                        @endif
                        <form action="{{route('post_reset_pass_user',$token)}}" method="post">
                            @csrf
        ...
        0px 0px 20px blue,
        0px 0px 30px yellow,
        0px 0px 40px pink;padding-bottom: 40px">Reset Password</p>
                                <input style="color: black;font-size: 16px;" type="password" required name="password" placeholder="Password new">
                                <input style="color: black;font-size: 16px;" type="password" required name="confirmpass" placeholder="Confirm password">
                                <button class="submit-btn-1 btn-hover-1" type="submit">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
