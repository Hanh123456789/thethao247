...
<div class="wrapper">
    ...
    <div class="login-section mb-80">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <img src="../public/thethao/images/bg/quangcao1.jpg" style="width: 100%;height: 428px;"/>
                </div>
                <div class="col-md-6">
        ...
        0px 0px 20px blue,
        0px 0px 30px yellow,
        0px 0px 40px pink;padding-bottom: 40px">Đăng Kí</p>

                                    <input  style="color: black;font-size: 16px";  type="text" name="name"  placeholder="Tên của bạn.......">
                                    <input style="color: black;font-size: 16px";  type="text" name="email"  placeholder="Email của bạn...">
                                    <input style="color: black;font-size: 16px";  type="password" name="password"  placeholder="Mật khẩu....">
                                    <input style="color: black;font-size: 16px";  type="password" name="confirmpassword"  placeholder="Nhập lại mật khẩu...">
                                    <div class="row">
                                        <div class="col-md-6">
                ...
                <!-- new-customers -->
                <div class="col-md-3">
                    <img src="../public/thethao/images/bg/quangcao2.jpg" style="width: 100%;height: 428px;"/>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <nav id="dropdown">
                            <ul>
                                <li><a href="index.html">Home</a>
                                    <ul>
                                        <li>
                                            <a href="index.html">Home Version a1</a>
                                        </li>
                                        <li>
